...
app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "gympulse-secret-key-2026")
...
DATA = {
    "GymPulse Downtown": {
        ...
        "capacity": "82%",
        "growth": 12.5,
        "monthly_revenue_trend": [22000, 25000, 28000, 31000, 33000, 35000],
        "member_data": [
            ("p-101", "David Watkins", "VIP Access", "Active", "$150/mo"),
            ("p-102", "Samuel Jackson", "Regular", "Active", "$80/mo"),
            ("p-103", "Emily Smith", "Regular", "Pending Renewal", "$80/mo"),
            ("p-104", "Sarah Jacob", "Yoga Pass", "Active", "$110/mo")
        ],
        "schedule": [
            ("08:00 AM", "Morning HIIT Blitz", "Coach Ryan", "Studio A", "Full"),
            ("10:30 AM", "Power Yoga", "Priya Patel", "Studio B", "5 Spots Left"),
            ("05:00 PM", "CrossFit Foundations", "Coach Mark", "Main Floor", "Full"),
            ("07:00 PM", "Spin & Cardio", "Jack Grace", "Cycle Room", "2 Spots Left")
        ]
    },
    "GymPulse Karama": {
        "revenue": 28900,
        ...
        "capacity": "90%",
        "growth": 15.8,
        "monthly_revenue_trend": [18000, 20000, 22500, 25000, 27000, 28900],
        "member_data": [
            ("p-201", "Liam Johnson", "Regular", "Active", "$80/mo"),
            ("p-202", "Olivia Brown", "VIP Access", "Expired", "$150/mo"),
            ("p-203", "Noah Davis", "Personal Training", "Active", "$250/mo"),
            ("p-204", "Emma Wilson", "Regular", "Pending Renewal", "$80/mo")
        ],
        "schedule": [
            ("07:00 AM", "Sunrise Yoga", "Priya Patel", "Studio B", "3 Spots Left"),
            ("09:00 AM", "Strength & Conditioning", "Coach Mark", "Main Floor", "Full"),
            ("06:00 PM", "Zumba Dance Party", "Coach Tyson", "Studio A", "Full"),
            ("08:00 PM", "Evening HIIT Blitz", "Coach Ryan", "Main Floor", "1 Spot Left")
        ]
    }
}
...
<body>
    <div class="login-card">
        ...
        <div class="demo-box">
            ...
            Downtown: <code>alpha</code> / <code>alpha123</code><br>
            Karama: <code>beta</code> / <code>beta123</code><br>
        </div>
    </div>
</body>
</html>
...
<body>
    <div class="sidebar">
        ...
        <a class="menu-item {% if page == 'Members' %}active{% endif %}" href="/members">Member Roster</a>
        <a class="menu-item {% if page == 'Schedule' %}active{% endif %}" href="/schedule">Class Schedule</a>
        <a class="menu-item {% if page == 'Analytics' %}active{% endif %}" href="/analytics">Financial Analytics</a>
...
def dashboard():
    ...
    content = """
    <div class="cards">
        <div class="card"><h3>Active Members</h3><div class="value">{{ d.members }}</div></div>
        <div class="card"><h3>Monthly Revenue</h3><div class="value">${{ "{:,}".format(d.revenue) }}</div></div>
...
def analytics():
    ...
    content = """
    <div class="cards">
        <div class="card"><h3>Total Revenue</h3><div class="value">${{ "{:,}".format(d.revenue) }}</div></div>
